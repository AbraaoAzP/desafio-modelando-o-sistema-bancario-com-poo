...
class Conta:
    ...
    def sacar(self, valor):
        ...
        if excedeu_saldo:
            print("Operação não realizada! O saldo em conta é insuficiente!")
...
class ContaCorrente(Conta):
    ...
    def sacar(self, valor):
        ...
        if excedeu_limite:
            print("Operação não realizada! O valor informado excede o limite!")

        elif excedeu_saques:
            print("Operação não realizada! O Número de saques diário foi excedido!")
...
def menu():
    ...
    Bem-vndo ao DioBank, por favor selecione uma das operações do menu abaixo:
...
def depositar(clientes):
    ...
    if not cliente:
        print("\nOperação não realizada! Cliente não encontrado!")
        return
